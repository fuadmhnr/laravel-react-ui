      ...
      {links.prev !== null
        ? (
          <Button asChild className='rounded-full text-xs px-6 mr-2' variant='outline' size='sm'>
            <Link preserveState preserveScroll href={links.prev}>Prev</Link>
          </Button>
        )
        : (
          <Button asChild className='rounded-full text-xs px-6 mr-2' variant='outline' size='sm' disabled>
            <span>Prev</span>
          </Button>
        )}
      ...
      {links.next !== null
        ? (
          <Button asChild className='rounded-full text-xs px-6' variant='outline' size='sm'>
            <Link preserveScroll preserveState href={links.next}>Next</Link>
          </Button>
        )
        : (
